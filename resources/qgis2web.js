...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">U.S. Critical Mineral Data Compendium</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (428 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map depicts geographic,  production, and emissions data for active copper, lithium, and nickel mines in the United States. Data come from the United States Geological Survey, Toxic Releases Inventory, National Emissions Inventory, Mine Data Retrieval System, and company reports and documents.  Disadvantaged tracts, as determined by the Justice40 initiative, are also on the map. All data are available for download <a href="https://github.com/jenmbdunn/Critical_Mineral_Mines_Database">HERE</a>. ';
            }

            hideAbstract();
        } else {
            linkElement.classList.add("project-abstract-uncollapsed");
            linkElement.innerHTML = 'This map depicts geographic,  production, and emissions data for active copper, lithium, and nickel mines in the United States. Data come from the United States Geological Survey, Toxic Releases Inventory, National Emissions Inventory, Mine Data Retrieval System, and company reports and documents.  Disadvantaged tracts, as determined by the Justice40 initiative, are also on the map. All data are available for download HERE. ';
        }
